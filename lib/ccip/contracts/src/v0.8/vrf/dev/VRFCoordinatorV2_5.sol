...
contract VRFCoordinatorV2_5 is VRF, SubscriptionAPI, IVRFCoordinatorV2Plus {
    ...
    function _getRandomnessFromProof(Proof memory proof, RequestCommitment memory rc)
        internal
        view
    ...
    */
        ...
        returns (uint96)
    {
        ...
        // stack too deep error
        {
            ...
            uint96 payment =
                _calculatePaymentAmount(startGas, s_config.gasAfterPaymentCalculation, tx.gasprice, nativePayment);
            if (nativePayment) {
