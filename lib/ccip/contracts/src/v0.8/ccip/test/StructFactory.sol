...
contract StructFactory {
    ...
    function generateDynamicOffRampConfig(address router, address priceRegistry)
        internal
        pure
    ...
    function generateDynamicOnRampConfig(address router, address priceRegistry)
        internal
        pure
        returns (EVM2EVMOnRamp.DynamicConfig memory)
    {
    ...
    function getTokensAndPools(address[] memory sourceTokens, IPool[] memory pools)
        internal
        pure
        returns (Internal.PoolUpdate[] memory)
    {
    ...
    function getSingleTokenPriceUpdateStruct(address token, uint224 price)
        internal
        pure
    ...
    function getSingleGasPriceUpdateStruct(uint64 chainSelector, uint224 usdPerUnitGas)
        internal
        pure
        returns (Internal.PriceUpdates memory)
    {
    ...
    function getPriceUpdatesStruct(address[] memory tokens, uint224[] memory prices)
        internal
        pure
        returns (Internal.PriceUpdates memory)
    {
