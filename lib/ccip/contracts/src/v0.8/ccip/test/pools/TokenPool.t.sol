...
contract TokenPool_setOnRampRateLimiterConfig is TokenPoolSetup {
    ...
    function setUp() public virtual override {
        ...
        s_onRamp = address(1);
        onRampUpdates1[0] =
            TokenPool.RampUpdate({ramp: s_onRamp, allowed: true, rateLimiterConfig: rateLimiterConfig()});
...
contract TokenPool_setOffRampRateLimiterConfig is TokenPoolSetup {
    ...
    function setUp() public virtual override {
        ...
        s_offRamp = address(1);
        offRampUpdates1[0] =
            TokenPool.RampUpdate({ramp: s_offRamp, allowed: true, rateLimiterConfig: rateLimiterConfig()});
